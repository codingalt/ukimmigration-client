     ...
     <div className="Container-forgetpassword-phase1">
             ...
             <div className='phase-1'>
              ...
              <p className='Form-data-heading'>Form Phase (iii)</p>
                ...
                <NavLink to="/rejectbyauthority">
                <button className='case-approved-option-3'>Case is been prepared for submission to authorities.</button>
                </NavLink>
                <NavLink to="/message">
...
export default FilldataAllphases2