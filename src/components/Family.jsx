                    ...
                    <div className='Main-form'>
                        <div className='left-side-phase'>
                            <form action="">
                                ...
                                <p className='genral-text-left-side'>3.Date of Marriage,  if Married*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />

                                <p className='genral-text-left-side'>4.Where you got married*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type' />

                                <p className='genral-text-left-side'>5.Date of birth of spouse *</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />

                                <p className='genral-text-left-side'>6.Nationality of spouse*</p>
                                ...
                                <p className='genral-text-left-side'>7.Passport number for spouse*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Number' />



                                <p className='genral-text-left-side'>8.Where did you meet?*</p>
                                <input type="text" className='genral-input-left-side' placeholder='' />


                                <p className='genral-text-left-side'>9.When did your relationship began*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Text' />

                                <p className='genral-text-left-side'>10.When you last saw each other*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />



                                <p className='genral-text-left-side'>11.Do you live together ?*</p>
                                ...
                                <p className='genral-text-left-side'>12.iv. What date you started living together?*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />




                                <p className='genral-text-left-side'>13.Do you have any children ?*</p>
                                ...
                                <p className='genral-text-left-side'>i. Child's Name*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Name' />
                                ...
                                <p className='genral-text-left-side'>iii. Date of Birth*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />


                                <p className='genral-text-left-side'>iv. Nationality of Child*</p>
                                <select class="form-select" placeholder='Select' className='genral-input-left-side-selector'  >
                                    <p className='select-country-11' >16.Select Country*</p>
                                    <option>Select</option>
                                    <option value="AF">Afghanistan</option>
                                ...
                                <p className='genral-text-left-side'>v. Passport Number*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Number' />


                                <p className='genral-text-left-side'>vi. Passport Issued Date*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />
                        ...
                        <div className='right-side-phase'>
                            <form action="">
                                <p className='genral-text-left-side'>vii. Passport Expiry Date*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />
                        ...
                        <option value="DZ">Other</option>
                                ...
                                <p className='genral-text-left-side'>ix. Visa Issued Date*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />

                                <p className='genral-text-left-side'>x. Visa Expiry Date*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />



                                <p className='genral-text-left-side'>13.Have you been married before ?*</p>
                                ...
                                <p className='genral-text-left-side'>ii. Date of Birth (mm/dd/yyyy)*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />


                                <p className='genral-text-left-side'>iii. Nationality ?*</p>
                                <select class="form-select" placeholder='Select' className='genral-input-left-side-selector'  >
                                    <p className='select-country-11' >16.Select Country*</p>
                                    <option>Select</option>
                                    <option value="AF">Afghanistan</option>
                                ...
                                <p className='genral-text-left-side'>iv. Date of Marriage (mm/dd/yyyy)*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />

                                <p className='genral-text-left-side'>v. Date of Divorce (mm/dd/yyyy)*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />
                                ...
                                <p className='genral-text-left-side'>14.Has your current partner been married before?*</p>
                                ...
                                <p className='genral-text-left-side'>i. Name of Ex-Partner*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type County' />

                                <p className='genral-text-left-side'>ii. Date of Birth*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />
                                ...
                                <p className='genral-text-left-side'>iv. Date of Marriage*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />

                                <p className='genral-text-left-side'>v. Date of Divorce*</p>
                                <input type="date" className='genral-input-left-side' name="" id="" />



                                <p className='genral-text-left-side'>15.What family/friends do you have in your home country ?*</p>
