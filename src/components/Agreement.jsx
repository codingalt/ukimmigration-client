        ...
        <div className="Container-forgetpassword-phase1">
            ...
            <div className="Forgetpassword-sub-2">
                ...
                <div className="checkbox">
                    ...
                    /> 
                        Request Consultation – Zoom/Telephone</p>
                </div>
                <p className="days-text">AFTER 30 DAYS THE APPLICATION WILL BE DELETED - NFA</p>
                <Link to="/phase3">
                <button onClick={handleSubmit} type="button" className="submit-agreement">Submit</button>
                </Link>
            </div>
        </div>
    );
