                    ...
                    <div className='Main-form'>
                        <div className='left-side-phase'>
                            <form action="">
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='Type Location' />


                                <p className='genral-text-left-side'>4.Location Code*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Location Code' />
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='Type Post Code' />


                                <p className='genral-text-left-side'>8.Country Prefix*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Country Prefix' />

                                <p className='genral-text-left-side'>9.Country*</p>
                                <select class="form-select" placeholder='Select' className='genral-input-right-side-selector'  >
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='FAX' />
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='Type Email' />

                                <p className='genral-text-left-side'>iii. Landlord's Telephone Number*</p>
                                <input type="text" className='genral-input-left-side' placeholder='+xxx-xxx-xxx-xxxx' />
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='Type town' />
                        ...
                        <div className='right-side-phase'>
                            <form action="">
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='Post Code' />


                                <p className='genral-text-left-side'>x. Country Prefix*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Country Prefix' />
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='VAT' />
                                ...
                                <input type="text" className='genral-input-left-side' placeholder='Type Location Name' />

                                <p className='genral-text-left-side'>iv. Location Code*</p>
                                <input type="text" className='genral-input-left-side' placeholder='Type Code ' />
